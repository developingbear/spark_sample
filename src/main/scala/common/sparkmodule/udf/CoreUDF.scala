...
package common.sparkmodule.udf

import org.apache.spark.sql.Row
import org.apache.spark.sql.functions.udf

trait CoreUDF extends Serializable{
  val strToMapUDF = udf(_strToMap _)
  val mapToTagMapUDF = udf(_mapToTagMap _)
  val convertIdTypeBitToReadableUDF = udf(_convertIdTypeBitToReadableOrigin _)
  val getRetargetProductCountUDF = udf(_getRetargetProductCount _)
