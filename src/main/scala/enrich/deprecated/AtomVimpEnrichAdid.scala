...
object AtomVimpEnrichAdid {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rankerDF = enrich.readRankerLog(Identifier.ADID, Ranker.VIMP)
    val atomRankerDF = enrich.joinAtomAndRankerLog(atomLogDF, rankerDF, Ranker.VIMP)

    enrich.write(Identifier.ADID, Ranker.VIMP, atomRankerDF, 3000)
